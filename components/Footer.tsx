                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="col-span-2">
                        <div className="flex items-center gap-3 mb-6">
                            <Image src="/logo.png" alt="ApexOne Studios Logo" width={32} height={32} className="w-8" style={{ height: 'auto' }} />
                        ...
                        <div className="flex gap-4">
                            {[
                                { name: 'X', url: 'https://x.com/Apexonestudio', path: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z' },
