...
export default function Solution() {
    return (
        <section id="solution" className="h-screen bg-[#050505] flex flex-col justify-center items-center relative overflow-hidden text-white">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                {/* Massive Heading */}
                <h2 className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter mb-10 leading-[0.9]">
                    One Platform.<br />
                    <span className="text-slate-600">Complete Visibility.</span>
                </h2>

                {/* Subheading */}
                <p className="text-xl md:text-2xl text-slate-400 max-w-2xl mx-auto leading-relaxed mb-24 font-light antialiased">
                ...
                <div className="grid md:grid-cols-3 gap-12 max-w-4xl mx-auto text-left">
                    {[
                        ...
                        <div key={i} className="border-t border-white/10 pt-6 group hover:border-white/30 transition-colors cursor-default">
                            ...
                            <p className="text-2xl md:text-3xl font-bold text-slate-200 group-hover:text-white transition-colors">{item.val}</p>
                        </div>
                    ))}
                </div>
            </div>
