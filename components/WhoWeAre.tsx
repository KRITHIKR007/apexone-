...
export default function WhoWeAre() {
    return (
        <section id="about" className="section bg-white text-slate-900 py-32 relative overflow-hidden">
            <div className="container relative z-10">
                ...
                <div className="grid md:grid-cols-3 gap-px bg-slate-200 border border-slate-200">
                    {[
                        ...
                        <div key={i} className="bg-slate-50 p-12 group hover:bg-white transition-colors duration-500">
                            <div className="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-lg flex items-center justify-center mb-8 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300">
